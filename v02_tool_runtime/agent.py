"""V02: the V01 Agent Loop plus a minimal multi-tool runtime."""
...
SYSTEM = (
    ...
    "Use glob, grep, and read_file for discovery; reserve bash for commands and tests. Run "
    "Python tests with 'python3.12 -m pytest', then give the final answer as soon as the "
    "requested result is verified. Report what you changed and what you verified."
)
TOOLS = [
    {
        "name": "bash",
